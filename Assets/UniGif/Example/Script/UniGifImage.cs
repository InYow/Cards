...
public class UniGifImage : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        UniGifImageAspectController imgAspectCtrl = GetComponent<UniGifImageAspectController>();
        if (imgAspectCtrl == null)
        {
            Debug.Log($"{gameObject.name}缺少UniGifImageAspectController");
        }
        else
        {
            m_imgAspectCtrl = imgAspectCtrl;
        }
    }
